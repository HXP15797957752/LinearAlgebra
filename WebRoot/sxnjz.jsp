...
<!-- registration -->
	<div class="main-1">
		...
		<div class="col-md-10"><hr>
			...
			<form action="<c:url value='/SxnjzServlet'/>" method="post">
					<h3>实现逆矩阵</h3>
					<p style="color: red; font-size: 11pt; font-weight: 900;">${msg}</p>
						<input type="text" name="t1" value="${form.t1} "> 
						<input type="text" name="t2" value="${form.t2}"><br/>
						<input type="text" name="t3" value="${form.t3} "> 
						<input type="text" name="t4" value="${form.t4}"><br/>
